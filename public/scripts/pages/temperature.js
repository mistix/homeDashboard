define(['jquery', 'tools'], function(jQuery, tools) {
	...
	jQuery.each(data, function(index, value) {
		...
		temperatureArray.push([tools.convertToDateTime(value.readingDateTime), value.airTemperature, value.heaterTemperature]);
	});
	...
	var options = {
		...
		trendlines: {
			...
			labelInLegend: 'Trend temperatury powietrza'
		    }
		}
	};
